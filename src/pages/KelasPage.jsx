    ...
    <div className="kelas min-vh-100">
      <Container>
        <Row>
          ...
          <p className="text-center  animate__animated animate__fadeInUp animate__delay-1s" >Lorem ipsum dolor sit, amet consectetur adipisicing elit. Optio, non.</p>
          </Col>
        </Row>
        <Row>
        {semuaKelas.map((kelas) => {
            return (
            <Col key={kelas.id} className='shawdow rounded' data-aos="fade-up" data-aos-duration="1000" data-aos-delay={kelas.delay} > 
