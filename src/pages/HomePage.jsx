        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <button
                className="btn btn-danger btn-lg rounder-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s"
                onClick={() => navigate("/kelas")}
              >
                lihat kelas
              </button>
              <button className="btn btn-outline-danger btn-lg rounder-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s">
                lihat promo
              </button>
            </Col>
